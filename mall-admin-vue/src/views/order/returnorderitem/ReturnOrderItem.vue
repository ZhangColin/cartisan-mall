    ...
    >
      <div class="drawer__content">
        <el-form ref="entityDataForm" :model="entityData" :rules="rules" label-width="120px">
          ...
          <el-form-item label="退货退款订单Id" prop="returnOrderId">
            <el-input v-model="entityData.returnOrderId" />
          </el-form-item>
          <el-form-item label="订单Id" prop="orderId">
            <el-input v-model="entityData.orderId" />
          </el-form-item>
          <el-form-item label="订单明细Id" prop="orderItemId">
            <el-input v-model="entityData.orderItemId" />
          </el-form-item>
