<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="封面" prop="image" />
      <el-table-column align="center" label="图片列表" prop="imageItems" />
    ...
    >
      <div class="drawer__content">
        <el-form ref="entityDataForm" :model="entityData" :rules="rules" label-width="120px">
          ...
          <el-form-item label="图片列表" prop="imageItems">
            <el-input v-model="entityData.imageItems" />
          </el-form-item>
        </el-form>
