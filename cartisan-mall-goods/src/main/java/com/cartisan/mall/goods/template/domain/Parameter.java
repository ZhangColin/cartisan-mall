 ...
 */
@Entity
@Table(name = "gds_parameters")
@Getter
public class Parameter extends AbstractEntity implements AggregateRoot {
    @Id
    ...
    public Parameter(Long templateId, String name, List<String> options, Integer sequence) {
