...
import com.cartisan.mall.system.user.domain.AssignService;
import com.cartisan.mall.system.user.domain.ChangePasswordService;
import com.cartisan.mall.system.user.domain.RegisterService;
import com.cartisan.mall.system.user.domain.User;
import com.cartisan.mall.system.user.request.AssignOrganizationsCommand;
import com.cartisan.mall.system.user.request.AssignRolesCommand;
import com.cartisan.mall.system.user.request.CreateAccountCommand;
import com.cartisan.mall.system.user.request.UserQuery;
import com.cartisan.mall.system.user.response.UserConverter;
import com.cartisan.mall.system.user.response.UserDetailConverter;
import com.cartisan.mall.system.user.response.UserDetailDto;
import com.cartisan.mall.system.user.response.UserDto;
